...
ActiveRecord::Schema.define(version: 2023_03_04_055729) do
  ...
  create_table "images_downloads", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["image_id"], name: "index_images_downloads_on_image_id"
  ...
  add_foreign_key "images_downloads", "images"
